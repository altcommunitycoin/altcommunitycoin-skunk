# Mac OS X altcommunitycoind Build Instructions
...
* See readme-qt.rst for instructions on building altcommunitycoin QT, the
...
## Building altcommunitycoin

    git clone https://github.com/altcommunitycoind/source altcommunitycoin
    cd altcommunitycoin/src
    make -f makefile.osx

## Useful commands

    ./altcommunitycoind --help  # for a list of command-line options.
    ./altcommunitycoind -daemon # to start the altcommunitycoin daemon.
    ./altcommunitycoind help    # When the daemon is running, to get a list of RPC commands
