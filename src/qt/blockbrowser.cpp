...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " altcom");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " altcom");
    }
}
...
void BlockBrowser::updateStatistics()
{
   ...
   // pwalletMain->GetStakeWeight(*pwalletMain, nWeight, nMaxWeight);
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"blue\">" + qVolume + " altcom" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " altcom" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " altcom");
    }
